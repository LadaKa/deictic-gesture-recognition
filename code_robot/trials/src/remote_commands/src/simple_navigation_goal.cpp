...
class simple_navigation_goal
{
    ...
    simple_navigation_goal(){
        sub = n.subscribe<geometry_msgs::PoseWithCovarianceStamped>("/amcl_pose", 100, &simple_navigation_goal::poseCallBack, this);
    }
};